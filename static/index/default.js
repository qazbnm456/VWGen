	...
	skills: [
		{
			...
			, rankDescriptions: [
				...
				, 'You understand how php works with server, and use some functions to acheive your goals.'
			]
            , links: [
                {
                    label: 'PHP official site'
                    , url: 'https://php.net/'
                }
            ]
			, maxPoints: 1
...

		{
            ...
            , rankDescriptions: [
                'You are familiar with XSS Attack.'
            ]
            , description: 'Cross-site scripting (XSS) is a type of computer security vulnerability typically found in web applications. XSS enables attackers to inject client-side script into web pages viewed by other users.'
		},
		{
			id: 3
			, title: 'Reflected XSS'
            ...
            , links: [
                {
                    label: 'Reflected XSS Intro on Wiki'
	                , url: 'https://en.wikipedia.org/wiki/Cross-site_scripting#Reflected_.28non-persistent.29'
                }
                , {
                    label: 'What is Reflected XSS?'
                    , url: 'http://security.stackexchange.com/questions/65142/what-is-reflected-xss'
                }
            ]
			, maxPoints: 2
            , rankDescriptions: [
                'Very basic Reflected XSS Attack vectors.'
                , 'A slightly harder Reflected XSS Attack vectors.'
            ]
            , description: 'Reflected attacks are those where the injected script is reflected off the web server.'
			, stats: [
				{
					title: 'Charisma'
					, value: 2
		...
		},
		{
			...
			, links: [
                {
                    label: 'Stored XSS Intro on Wiki'
	                , url: 'https://en.wikipedia.org/wiki/Cross-site_scripting#Persistent'
                }
                , {
                    label: 'Stored XSS Intro on OWASP'
                    , url: 'https://www.owasp.org/index.php/Cross-site_Scripting_(XSS)#Stored_and_Reflected_XSS_Attacks'
                }
            ]
			, maxPoints: 2
            , rankDescriptions: [
                'Very basic Stored XSS Attack vectors.'
                , 'A slightly harder Stored XSS Attack vectors.'
            ]
            , description: 'Stored xss attacks are those where the injected script is permanently stored on the target servers.'
			, stats: [
				{
					title: 'Charisma'
					, value: 10
